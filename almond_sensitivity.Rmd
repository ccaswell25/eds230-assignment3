...
sensi_almond = profit %>% map(~calculate_almond_profit(cost_per_hectare = .x, price_per_kg = 200, discount_rate, years)) 

# Create a dataframe of just annual data
tmp = map_df(sensi_almond,`[`, c("annual")) 

site2df = data.frame(year = tmp$annual$year, profit= tmp$annual$elect) #need to update this with relevant details for profit calc
